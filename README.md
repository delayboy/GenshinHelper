...
- [GenshinHelper](#genshinhelper)
    ...
    - [配置文件](#配置文件)
    - [工具文件](#工具文件)
    - [不安装任何python环境如何修改源码](#不安装任何python环境如何修改源码)
    - [如何使用插件定义自己的鼠标宏](#如何使用插件定义自己的鼠标宏)
    - [如何使用云游戏挂机功能](#如何使用云游戏挂机功能)
    - [如何切换云砍树](#如何切换云砍树)
    - [如何编排自己的自动化云脚本（可扩展神经网络模型）](#如何编排自己的自动化云脚本可扩展神经网络模型)
    - [如何开启原神无边框窗口模式获取更流畅的窗口切换体验](#如何开启原神无边框窗口模式获取更流畅的窗口切换体验)
...
使用云挂机脚本：**一定要用非管理员运行！！！一定要用非管理员运行！！！一定要用非管理员运行！！！**
...
## 如何开启原神无边框窗口模式获取更流畅的窗口切换体验

如何开启无边框窗口：

- 在原神启动器文件夹下找到Genshin Impact Game文件夹

- 打开Genshin Impact Game文件夹后，找到YuanShen.exe右击【在桌面创建快捷方式】。
- 回到桌面右击之前创建的快捷方式，打开快捷方式属性面板
- 在快捷方式【目标】属性中追加 `-popupwindow`参数，即可以无边框窗口方式启动原神。
